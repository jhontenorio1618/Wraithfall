...
#Text lines
text_lines = [
    textbox.TextBox("I don't like the looks of this... stay quiet.", "Grandpa", "Mad"), #grandpa
    textbox.TextBox("Incredible... like it's straight out of a fantasy novel.", "Grandpa", "Neutral"), #grandpa
